                ...
                <div class="card-body">
                    ...
                    <form class="" method="POST" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nis" type="text" class="form-control @error('kelas') is-invalid @enderror" name="nama_kelas" placeholder="masukan nama kelas" required autocomplete="kelas" autofocus>
